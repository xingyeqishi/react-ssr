...
module.exports = {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([
      {from: srcPath + '/assets/**/*', to: distPath + "/assets/", flatten: true}
    ]),
    /*
    new ImageminPlugin({
      test: /\.(png)$/i,
    ...
    */
    new CopyWebpackPlugin([
      {from: srcPath + '/ppt/**/*', to: distPath + "/ppt/", flatten: true}
    ]),
    ...
    rules: [{
      ...
      use: [
        ...
        'sass-loader',
        {
          ...
          options: {
            resources: ['./node_modules/include-media/dist/_include-media.scss', './node_modules/sass-resolution/_resolution.scss']
          }
        }
      ]
    }, {
